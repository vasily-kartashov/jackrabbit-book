...
This is a very simple visitor.

@ToDo add full json serialization (namespace filtering and all) 
@Todo look for other Visitors already implemented and see what they do
